...
Exec=/usr/bin/chromium-browser --password-store=basic --kiosk --noerrdialogs --disable-infobars --disable-session-crashed-bubble --enable-features=OverscrollHistoryNavigation http://localhost:5000
Hidden=false
NoDisplay=false
